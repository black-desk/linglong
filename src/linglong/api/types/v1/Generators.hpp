...
#include "linglong/api/types/v1/PackageManager1QueryResult.hpp"
#include "linglong/api/types/v1/PackageManager1QueryParameters.hpp"
...
void from_json(const json & j, PackageManager1QueryParameters & x);
void to_json(json & j, const PackageManager1QueryParameters & x);

void from_json(const json & j, PackageManager1QueryResult & x);
void to_json(json & j, const PackageManager1QueryResult & x);
...
x.checksum = get_stack_optional<std::string>(j, "checksum");
x.kind = j.at("kind").get<std::string>();
...
x.channel = j.at("channel").get<std::string>();
x.id = j.at("id").get<std::string>();
x.packageManager1PackageModule = j.at("module").get<std::string>();
x.version = j.at("version").get<std::string>();
}
...
inline void from_json(const json & j, PackageManager1QueryParameters& x) {
x.package = j.at("package").get<PackageManager1Package>();
x.remote = get_stack_optional<bool>(j, "remote");
}

inline void to_json(json & j, const PackageManager1QueryParameters & x) {
j = json::object();
j["package"] = x.package;
if (x.remote) {
j["remote"] = x.remote;
...
inline void from_json(const json & j, PackageManager1QueryResult& x) {
x.packages = j.at("packages").get<std::vector<PackageManager1Package>>();
x.code = j.at("code").get<int64_t>();
x.message = j.at("message").get<std::string>();
}

inline void to_json(json & j, const PackageManager1QueryResult & x) {
j = json::object();
...
x.packageManager1InstallResult = get_stack_optional<CommonResult>(j, "PackageManager1InstallResult");
...
x.packageManager1QueryParameters = get_stack_optional<PackageManager1QueryParameters>(j, "PackageManager1QueryParameters");
x.packageManager1QueryResult = get_stack_optional<PackageManager1QueryResult>(j, "PackageManager1QueryResult");
...
x.packageManager1UpdateResult = get_stack_optional<CommonResult>(j, "PackageManager1UpdateResult");
...
if (x.packageManager1QueryParameters) {
j["PackageManager1QueryParameters"] = x.packageManager1QueryParameters;
}
if (x.packageManager1QueryResult) {
j["PackageManager1QueryResult"] = x.packageManager1QueryResult;
}
