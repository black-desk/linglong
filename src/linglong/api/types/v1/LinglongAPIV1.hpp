...
std::optional<CommonResult> packageManager1InstallResult;
...
std::optional<PackageManager1QueryParameters> packageManager1QueryParameters;
std::optional<PackageManager1QueryResult> packageManager1QueryResult;
...
std::optional<CommonResult> packageManager1UpdateResult;
